        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Your trusted partner in finding the perfect home. We deliver exceptional service and expertise in luxury real estate.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">123 Luxury Avenue, Premium District</span>
              </div>
              <div className="flex items-center space-x-3">
